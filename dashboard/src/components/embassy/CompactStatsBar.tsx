...
export interface CompactStat {
  ...
  color: string;
  /** true → mock/demo figure; renders a tiny "تجريبي" chip beside the number. */
  demo?: boolean;
}

// Compact horizontal stat bar (Intelligence-Terminal style): merged numbers, no
// large separate cards. Each stat colour-codes its own value; demo figures carry
// a tiny "تجريبي" chip; the full description appears as a tooltip on hover OR
// click (click toggles it, for touch), never as a permanent caption.
      ...
      {stats.map((s) => {
        ...
        return (
          ...
          >
            ...
            {s.demo && <span className="compact-stat-demo">تجريبي</span>}
